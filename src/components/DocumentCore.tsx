    ...
    >
      ...
      >
        ...
        <div className="relative z-10 my-auto py-2 space-y-3 font-mono text-[11px] leading-relaxed">
          ...
          <div>
            {isCleaned ? (
              <div className="font-bold text-[#2C2830] bg-[#A8D5C2]/20 p-1.5 rounded border border-[#A8D5C2]/40 flex items-center justify-between truncate">
                <span className="truncate">{title.toUpperCase()}</span>
                <span className="text-[#3C8D87] font-bold text-[9px] flex-shrink-0 ml-2">RESTORED</span>
              </div>
            ) : (
              <div className="text-[#C65D45] bg-[#C65D45]/10 p-1.5 rounded border border-[#C65D45]/25 truncate">
            ...
            {isCleaned ? (
              <>
                <p className="text-[#2C2830]">
                  Restored content stream for {title}.
                </p>
                <p className="text-[#2C2830]">
                  Optical baselines, spacing, and character glyphs verified.
                </p>
              </>
            ) : (
              <>
                <p className="text-[#6F6670] line-through decoration-[#C65D45]">
                  Analyzing raw document stream for {title}...
                </p>
                <p className="text-[#6F6670]">
                  Inspecting OCR artifacts, paragraph wraps, and typography...
                </p>
              </>
            )}
          </div>
